...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color greenPrimaryColor = Color(0xff296e48);
    const Color greenAccentColor = Color(0xFFC8E6C9);

    return Scaffold(
      appBar: AppBar(
        title: Text('Enter OTP', style: TextStyle(color: greenAccentColor)),
        ...
        child: Column(
          children: <Widget>[
            ...
            Align(
              ...
              child: Text(
                'OTP Verification',
                style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: greenPrimaryColor),
              ),
            ),
            SizedBox(height: 10),
            Align(
            ...
            PinCodeTextField(
              ...
              pinTheme: PinTheme(
                activeColor: greenPrimaryColor,
                selectedColor: greenAccentColor,
